-- Migration 0009: Reflection Engine
-- Description: Adds confidence_score and metadata to memory proposals for high-signal reflection.

PRAGMA foreign_keys=OFF;

-- 1. Update memory_proposals with confidence_score and metadata_json
...
INSERT INTO memory_proposals_new (
    ...
    proposed_tags_json, reason, status, importance, source_ids_json, 
...
-- 2. Update long_term_memory with metadata_json
...
INSERT INTO long_term_memory_new (
    ...
    tags_json, source, importance, access_count, last_retrieved_at, 
...
-- 3. Re-create triggers for FTS5 (long_term_memory_idx already exists, just re-attach triggers)
