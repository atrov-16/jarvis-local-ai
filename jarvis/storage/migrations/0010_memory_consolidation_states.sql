-- Migration 0010: Memory Consolidation States
-- Description: Adds status field to long_term_memory to support consolidation (active, flagged, archived, merged).

PRAGMA foreign_keys=OFF;

-- 1. Update long_term_memory with status
...
SELECT 
    ...
    importance, access_count, last_retrieved_at, source_ids_json, 
